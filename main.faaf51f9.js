				...
				function e(e) {
					return this.each(function() {
						...
						(!o && /destroy|hide/.test(e)) ||
							(o || i.data('bs.tooltip', (o = new n(this, s))), 'string' == typeof e && o[e]());
					});
				}
				var n = function(t, e) {
					(this.type = null),
					...
					(n.prototype.show = function() {
						...
						if (this.hasContent() && this.enabled) {
									...
									'bottom' == a && u.bottom + f > h.bottom
										...
										: 'top' == a && u.top - f < h.top
											...
											: 'right' == a && u.right + p > h.width
												? 'left'
												: 'left' == a && u.left - p < h.left ? 'right' : a),
							...
							t.support.transition && this.$tip.hasClass('fade')
								? s.one('bsTransitionEnd', v).emulateTransitionEnd(n.TRANSITION_DURATION)
								: v();
						}
					}),
		...
		!(function() {
			...
			function r(t, e) {
				return 'string' == typeof t
					...
					: N.tools.isNode(t) ? [ t ] : N.tools.isNodeList(t) ? Array.prototype.slice.call(t) : [];
			}
			function a() {
				return ++N.uid;
			}
			...
			function v() {
				...
				N.tools.forOwn(N.sequences, function(o) {
					...
					for (var s = 0; s < i.elemIds.length; s++)
						(n = i.elemIds[s]), (e = N.store.elements[n]), S(e) && !t && (t = !0);
					i.active = t;
				});
			}
			function m() {
			...
			(o.prototype.defaults = {
				...
				(o.prototype.isSupported = function() {
					...
					return (
						('WebkitTransition' in t && 'WebkitTransform' in t) || ('transition' in t && 'transform' in t)
					);
				}),
				(o.prototype.reveal = function(t, e, n, i) {
					...
					n &&
						'number' == typeof n &&
						((m = a()), (v = N.sequences[m] = { id: m, interval: n, elemIds: [], active: !1 }));
					for (var y = 0; y < u.length; y++)
						(g = u[y].getAttribute('data-sr-id')),
							...
							(N.tools.isMobile() && !p.config.mobile) || !N.isSupported()
								...
								: p.revealing ||
									p.domEl.setAttribute('style', p.styles.inline + p.styles.transform.initial);
					return (
						!i &&
							N.isSupported() &&
							(d(t, e, n),
							...
							o.hasClass('open') &&
								((n &&
									...
									n.isDefaultPrevented() ||
										...
										o.removeClass('open').trigger(t.Event('hidden.bs.dropdown', s)))));
						}));
				}
				function i(e) {
					return this.each(function() {
	...
	juYr: function(t, e, n) {
		...
		!(function(e, n) {
			...
			function h(t, e, n, i) {
				...
				try {
					t && yt.isFunction((o = t.promise))
						...
						: t && yt.isFunction((o = t.then)) ? o.call(t, e, n) : e.apply(void 0, [ t ].slice(i));
				} catch (t) {
					n.apply(void 0, [ t ]);
				}
			}
			...
			function m(t) {
				return (
					'true' === t ||
					('false' !== t && ('null' === t ? null : t === +t + '' ? +t : Wt.test(t) ? JSON.parse(t) : t))
				);
			}
			function y(t, e, n) {
				var i;
				if (void 0 === n && 1 === t.nodeType)
					if (
						((i = 'data-' + e.replace(Mt, '-$&').toLowerCase()), 'string' == typeof (n = t.getAttribute(i)))
					) {
						try {
							n = m(n);
						} catch (t) {}
				...
				for (var n, i, o = [], s = 0, r = t.length; s < r; s++)
					(i = t[s]),
						i.style &&
							...
							e
								? ('none' === n &&
										((o[s] = Ft.get(i, 'display') || null), o[s] || (i.style.display = '')),
						...
						for (u = a[a.length - 1].ownerDocument, yt.map(a, j), p = 0; p < c; p++)
							(l = a[p]),
								Qt.test(l.type || '') &&
									...
									yt.contains(u, l) &&
									(l.src ? yt._evalUrl && yt._evalUrl(l.src) : r(l.textContent.replace(ae, ''), u));
				}
				return t;
			}
			function R(t, e, n) {
				for (var i, o = e ? yt.filter(e, t) : t, s = 0; null != (i = o[s]); s++)
					n || 1 !== i.nodeType || yt.cleanData(T(i)),
						i.parentNode &&
							(n && yt.contains(i.ownerDocument, i) && C(T(i, 'script')), i.parentNode.removeChild(i));
				return t;
			}
			function q(t, e, n) {
				var i,
					...
					'margin' === n && (r += yt.css(t, n + _t[s], !0, o)),
						i
							? ('content' === n && (r -= yt.css(t, 'padding' + _t[s], !0, o)),
								'margin' !== n && (r -= yt.css(t, 'border' + _t[s] + 'Width', !0, o)))
							: ((r += yt.css(t, 'padding' + _t[s], !0, o)),
								'padding' !== n && (r += yt.css(t, 'border' + _t[s] + 'Width', !0, o)));
				return r;
			}
			function U(t, e, n) {
				var i,
				...
				return le.test(s)
					...
					: ((i = r && (mt.boxSizingReliable() || s === t.style[e])),
						...
						(s = parseFloat(s) || 0) + M(t, e, n || (r ? 'border' : 'content'), i, o) + 'px');
			}
				...
				if ((c = !yt.isEmptyObject(e)) || !yt.isEmptyObject(d)) {
					p &&
						...
						'none' === u &&
							(l
								? (u = l)
								: (w([ t ], !0), (l = t.style.display || l), (u = yt.css(t, 'display')), w([ t ]))),
			...
			function Q(t, e, n) {
				var i,
					...
					c = function() {
						...
						return (
							...
							s < 1 && c ? n : (c || a.notifyWith(t, [ l, 1, 0 ]), a.resolveWith(t, [ l ]), !1)
						);
					},
					l = a.promise({
						elem: t,
				...
				for (G(u, l.opts.specialEasing); s < r; s++)
					if ((i = Q.prefilters[s].call(l, t, u, l.opts)))
						return (
							yt.isFunction(i.stop) && (yt._queueHooks(l.elem, l.opts.queue).stop = yt.proxy(i.stop, i)),
							i
						);
				return (
					yt.map(u, V, l),
			...
			function Z(t, e, n, i) {
				...
				if (Array.isArray(e))
					yt.each(e, function(e, o) {
						n || $e.test(t)
							? i(t, o)
							: Z(t + '[' + ('object' == typeof o && null != o ? e : '') + ']', o, n, i);
					});
			...
			(yt.fn = yt.prototype = {
				...
				yt.extend({
					...
					isPlainObject: function(t) {
						...
						return (
							...
							(!(e = at(t)) ||
								('function' == typeof (n = ht.call(e, 'constructor') && e.constructor) &&
									gt.call(n) === vt))
						);
					},
					...
					type: function(t) {
						return null == t
							? t + ''
							: 'object' == typeof t || 'function' == typeof t ? ft[dt.call(t)] || 'object' : typeof t;
					},
					...
					makeArray: function(t, e) {
						var n = e || [];
						return (
							null != t && (a(Object(t)) ? yt.merge(n, 'string' == typeof t ? [ t ] : t) : ut.call(n, t)),
							n
						);
					},
				...
				yt.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), function(
					t,
					e
				) {
				...
				(x = e.support = {}),
								...
								(w.find.TAG = x.getElementsByTagName
									? function(t, e) {
											return void 0 !== e.getElementsByTagName
												...
												: x.qsa ? e.querySelectorAll(t) : void 0;
										}
									: function(t, e) {
											var n,
												i = [],
					...
					(e.matchesSelector = function(t, n) {
						if (
							...
							(n = n.replace(ct, "='$1']")),
							x.matchesSelector && I && !_[n + ' '] && (!R || !R.test(n)) && (!L || !L.test(n)))
						)
							try {
								var i = q.call(t, n);
											...
											if (v) {
												...
												if (((h = [ r ? v.firstChild : v.lastChild ]), r && y)) {
													...
													for (
														;
														(f = (++d && f && f[g]) || (b = d = 0) || h.pop()) &&
														((a ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) ||
															!++b ||
															(y &&
																((p = f[F] || (f[F] = {})),
																(u = p[f.uniqueID] || (p[f.uniqueID] = {})),
					...
					(S = e.select = function(t, e, n, i) {
						...
						if (((n = n || []), 1 === f.length)) {
							...
							for (
								...
								if (
									(c = w.find[a]) &&
									(i = c(r.matches[0].replace(mt, yt), (vt.test(s[0].type) && l(e.parentNode)) || e))
								) {
			...
			((yt.fn.init = function(t, e, n) {
				...
				if (((n = n || At), 'string' == typeof t)) {
					...
					if (i[1]) {
						if (
							...
							yt.merge(this, yt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : rt, !0)),
				...
				return t.nodeType
					...
					: yt.isFunction(t) ? (void 0 !== n.ready ? n.ready(t) : t(yt)) : yt.makeArray(t, this);
			}).prototype =
				yt.fn),
				(At = yt(rt));
			...
			yt.fn.extend({
					...
					if (!St.test(t))
						for (; i < o; i++)
							for (n = this[i]; n && n !== e; n = n.parentNode)
								if (
									n.nodeType < 11 &&
									(r ? r.index(n) > -1 : 1 === n.nodeType && yt.find.matchesSelector(n, t))
								) {
									s.push(n);
									break;
								}
				...
				index: function(t) {
					return t
						? 'string' == typeof t ? pt.call(yt(t), this[0]) : pt.call(this, t.jquery ? t[0] : t)
				...
				yt.each(
					{
						...
						contents: function(t) {
							return c(t, 'iframe')
								? t.contentDocument
								: (c(t, 'template') && (t = t.content || t), yt.merge([], t.childNodes));
						}
					},
					function(t, e) {
				...
				var e,
					...
					l = {
						...
						fireWith: function(t, n) {
							return (
								o || ((n = n || []), (n = [ t, n.slice ? n.slice() : n ]), r.push(n), e || c()), this
							);
						},
						fire: function() {
				...
				yt.extend({
					...
					ready: function(t) {
						(!0 === t ? --yt.readyWait : yt.isReady) ||
							((yt.isReady = !0), (!0 !== t && --yt.readyWait > 0) || Rt.resolveWith(rt, [ yt ]));
					}
				}),
				(yt.ready.then = Rt.then),
				'complete' === rt.readyState || ('loading' !== rt.readyState && !rt.documentElement.doScroll)
					? n.setTimeout(yt.ready)
					: (rt.addEventListener('DOMContentLoaded', g), n.addEventListener('load', g));
						...
						if (void 0 === t) {
							if (this.length && ((o = Ht.get(s)), 1 === s.nodeType && !Ft.get(s, 'hasDataAttrs'))) {
								for (n = r.length; n--; )
									r[n] &&
										((i = r[n].name),
										0 === i.indexOf('data-') && ((i = yt.camelCase(i.slice(5))), y(s, i, o[i])));
						...
						for (r = yt.event.handlers.call(this, a, l), e = 0; (o = r[e++]) && !a.isPropagationStopped(); )
							for (
								...
								(a.rnamespace && !a.rnamespace.test(s.namespace)) ||
									...
									(a.data = s.data),
									void 0 !==
										(i = ((yt.event.special[s.origType] || {}).handle || s.handler)
											.apply(o.elem, c)) &&
										!1 === (a.result = i) &&
							...
							handle: function(t) {
								...
								return (
									(o && (o === i || yt.contains(i, o))) ||
										((t.type = s.origType), (n = s.handler.apply(this, arguments)), (t.type = e)),
									n
								);
							}
						};
					...
					function(t, e) {
						yt.fn[t] = function(t) {
							for (var n, i = [], o = yt(t), s = o.length - 1, r = 0; r <= s; r++)
								(n = r === s ? this : this.clone(!0)), yt(o[r])[e](n), ut.apply(i, n.get());
			...
			(yt.Animation = yt.extend(Q, {
				...
				tweener: function(t, e) {
					...
					for (var n, i = 0, o = t.length; i < o; i++)
						(n = t[i]), (Q.tweeners[n] = Q.tweeners[n] || []), Q.tweeners[n].unshift(e);
				},
				prefilters: [ X ],
					...
					propHooks: {
						tabIndex: {
							get: function(t) {
								...
								return e
									? parseInt(e, 10)
									: Ce.test(t.nodeName) || (Ee.test(t.nodeName) && t.href) ? 0 : -1;
							}
						}
					},
					...
					ajax: function(t, e) {
						function i(t, e, i, a) {
							...
							u ||
								...
								y.fireWith(g, [ C, T ]),
								p &&
									(v.trigger('ajaxComplete', [ C, h ]), --yt.active || yt.event.trigger('ajaxStop')));
						}
						...
						var o,
							...
							C = {
								...
								setRequestHeader: function(t, e) {
									return (
										null == u && ((t = w[t.toLowerCase()] = w[t.toLowerCase()] || t), (x[t] = e)),
										this
									);
								},
						...
						(p = yt.event && h.global),
							...
							h.hasContent
								...
								: ((d = h.url.slice(s.length)),
									...
									!1 === h.cache &&
										((s = s.replace(qe, '$1')), (d = (Ae.test(s) ? '&' : '?') + '_=' + Ne++ + d)),
									(h.url = s + d)),
							h.ifModified &&
								(yt.lastModified[s] && C.setRequestHeader('If-Modified-Since', yt.lastModified[s]),
							...
							C.setRequestHeader(
								...
								h.dataTypes[0] && h.accepts[h.dataTypes[0]]
									? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + Be + '; q=0.01' : '')
									: h.accepts['*']
							);
			...
			(mt.cors = !!Ye && 'withCredentials' in Ye),
				...
				yt.ajaxTransport('script', function(t) {
					if (t.crossDomain) {
						...
						return {
							send: function(i, o) {
								(e = yt('<script>').prop({ charset: t.scriptCharset, src: t.url }).on(
									'load error',
									(n = function(t) {
			...
			yt.ajaxSetup({
				...
				(yt.parseHTML = function(t, e, n) {
					...
					return (
						...
						o
							? [ e.createElement(o[1]) ]
							: ((o = E([ t ], e, s)), s && s.length && yt(s).remove(), yt.merge([], o.childNodes))
					);
				}),
				...
				yt.each([ 'ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend' ], function(
					t,
					e
				) {
					yt.fn[e] = function(t) {
								...
								function(e, n, o) {
									...
									return yt.isWindow(e)
										...
										: 9 === e.nodeType
											...
											: void 0 === o ? yt.css(e, n, a) : yt.style(e, n, o, a);
								},
								e,
								r ? o : void 0,
								r
				...
				function e(e) {
					return this.each(function() {
						var i = t(this),
							...
							s = 'object' == typeof e && e;
						(!o && /destroy|hide/.test(e)) ||
							(o || i.data('bs.popover', (o = new n(this, s))), 'string' == typeof e && o[e]());
					});
				}
				var n = function(t, e) {
						...
						e && e.preventDefault(),
							...
							e.isDefaultPrevented() ||
								...
								t.support.transition && r.hasClass('fade')
									? r.one('bsTransitionEnd', n).emulateTransitionEnd(i.TRANSITION_DURATION)
									: n());
					});
				var o = t.fn.alert;
				(t.fn.alert = e),
